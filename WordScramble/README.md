...
Download zip file and extract it [latest release](https://github.com/reysmerwvr/SwiftUI-Series/WordScramble). Or clone the repository and open it using Xcode.
