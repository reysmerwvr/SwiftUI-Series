...
Download zip file and extract it [latest release](https://github.com/reysmerwvr/SwiftUI-Series/BeaconDetector). Or clone the repository and open it using Xcode.
